...
class Met_pi(PiBase):
    ...
    def parameters(self, dist_cutoff=7.0, angle_cutoff=90):
...
def find_Met_pi_interactions(polymer, acceptor_codes=None, dist_cutoff=7.0, angle_cutoff=90,inter_chain=True):
